...
export class CommonService {
	...
	public doSpinner: boolean = false;
	...
	public messageLoginFirst: string = 'Login First';
  	...
  	public langs = [{value: 'en', name: 'English'}, {value: 'ko', name: '한글'}];
				  
  	public coutries :any = [{value: 'US', name: 'United States', selected: true},
  ...
  getObject(key: string): any {
	const paserData = localStorage.getItem(key);
		if (paserData !== null ) return JSON.parse(paserData);
		return null;
	}
